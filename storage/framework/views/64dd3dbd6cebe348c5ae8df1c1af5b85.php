...
<head>
    ...
    <title><?php echo e($title ?? config('app.name')); ?> — Gestão de Equipe</title>
...
<div x-data="{ open: false, mobile: false }" class="flex h-full">
    ...
    <aside wire:ignore
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll py-3 px-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAdmin() || auth()->user()->isSuperAdmin() || auth()->user()->isManager()): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make('layouts.partials.nav-item',$item, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make('layouts.partials.nav-item',$item, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <div x-show="!open" x-cloak class="px-3 pt-4 pb-1">
                    <p class="text-[10px] font-semibold uppercase tracking-widest text-white/25">Recrutamento</p>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nav3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make('layouts.partials.nav-item',$item, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isEmployee() || auth()->user()->isManager()): ?>
                <div x-show="!open" x-cloak class="px-3 pt-4 pb-1">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navP; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo $__env->make('layouts.partials.nav-item',$item, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="border-t border-white/10 px-3 py-3 flex-shrink-0">
            <?php $initials=collect(explode(' ',auth()->user()->name))->map(fn($w)=>strtoupper(substr($w,0,1)))->take(2)->join(''); ?>
            <div class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-lg flex-shrink-0 flex items-center justify-center text-white text-xs font-bold"
                     style="background:linear-gradient(135deg,#EC0000,#7B0000);"><?php echo e($initials); ?></div>
                <div x-show="!open" x-cloak class="flex-1 min-w-0">
                    ...
                    <p class="text-white/40 text-[10px]"><?php echo e(str_replace('_',' ',auth()->user()->getRoleNames()->first()??'')); ?></p>
                </div>
    ...
    <div class="flex flex-col flex-1 min-h-screen main-content"
        ...
        <header class="sticky top-0 z-30 flex-shrink-0 bg-white/90 backdrop-blur border-b border-black/[0.07]">
            <div class="flex items-center justify-between px-5 py-3">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-sm font-semibold text-neutral-text"><?php echo e($title ?? 'Dashboard'); ?></h1>
                        <p class="text-[11px] text-neutral-muted hidden sm:block"><?php echo e(now()->isoFormat('dddd, D [de] MMMM [de] YYYY')); ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    ...
                    <button class="w-8 h-8 flex items-center justify-center rounded-lg text-neutral-muted hover:bg-neutral-bg relative">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unread>0): ?><span class="absolute top-1 right-1 w-2 h-2 rounded-full bg-red-600 ring-2 ring-white"></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </button>
                    ...
                    <div class="relative" x-data="{ dd: false }" @click.outside="dd=false">
                        <button type="button" @click="dd=!dd" class="flex items-center gap-2 pl-1 pr-2.5 py-1 rounded-lg hover:bg-neutral-bg">
                            ...
                            <div class="hidden sm:block text-left">
                                <p class="text-xs font-semibold text-neutral-text"><?php echo e(auth()->user()->name); ?></p>
                                <p class="text-[10px] text-neutral-muted"><?php echo e(str_replace('_',' ',ucfirst(auth()->user()->getRoleNames()->first()??''))); ?></p>
                            </div>
                        ...
                        <div x-show="dd" x-cloak
                            ...
                            <div class="px-3 py-2.5 border-b border-gray-100">
                                ...
                                <p class="text-[11px] text-neutral-muted truncate"><?php echo e(auth()->user()->email); ?></p>
                            </div>
        ...
        <footer class="px-6 py-3 border-t border-gray-200 flex items-center justify-between flex-shrink-0">
            <span class="text-[11px] text-neutral-muted">© <?php echo e(date('Y')); ?> Santander — Uso interno corporativo</span>
...
<script>
(function(){
    var full = '<?php echo e(url("livewire/update")); ?>';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/gestao-equipe/resources/views/layouts/app.blade.php ENDPATH**/ ?>